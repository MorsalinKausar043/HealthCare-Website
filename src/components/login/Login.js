                ...
                <div className="row d-flex justify-content-center align-items-center">
                    <div className="col-10 mx-auto col-md-4 shadow p-3 rounded">
                        ...
                        <div className="d-flex flex-column">
                            <input className="log_input" type="email" placeholder="Enter Your Email" required />
                            <input className="mt-3 log_input" type="password" placeholder="Enter Your Password" required />
                        </div>
                        ...
                        <div className="text-center mb-3">
                            <button className="btn btn-primary"><BiLogIn/> Sign In</button>
                        </div>
